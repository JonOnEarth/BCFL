...
class CNNCifarImproved(nn.Module):
    """Improved CNN for CIFAR-10 with batch normalization and dropout"""
    def __init__(self, num_classes=10):
        super(CNNCifarImproved, self).__init__()
