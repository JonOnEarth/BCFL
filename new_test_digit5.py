...
def main(seeds, dataset_splited, model, model_name, K=None,n_assign=None,cost_method='weighted',warm_up=False,warm_up_rounds=2):
    ...
    if model_name == 'FedAvg':
        ...
        fedsoft.run(dataset_splited, batch_size, K, num_nodes, model, nn.CrossEntropyLoss, optimizer, global_rounds, local_steps, selection_size=5,num_classes=10,reg_lam=0.1,device = device)
...
if __name__ == '__main__':
    ...
    model_name_list0 = ['FedEM'] # # BayesPFedAvg''FedAvg',#,，FedSoft,'BayesFedAvg','Fesem',,,,,'GNN','FedAvg',Wecfl,Fesem
